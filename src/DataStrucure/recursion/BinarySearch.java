...
public class BinarySearch {
    public static void main(String[] args) {
        ...
        ArrayList<Integer> arraylist = (linearSearch(arr, 0, target, new ArrayList<>()));
        System.out.println(arraylist);
        System.out.println(list);

    }

    private static ArrayList<Integer> linearSearch(int[] arr, int index, int target, ArrayList<Integer> list) {
